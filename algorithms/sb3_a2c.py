"""Stable-Baselines3 A2C helpers for the maze environment."""
...
def make_a2c_env(
    *,
    ...
    """Build a monitored maze factory for SB3."""
    ...
    def _make_env() -> Any:
        try:
            ...
            raise ImportError(
                "Stable-Baselines3 is required for A2C support. "
...
def build_a2c_model(
    *,
    ...
    """Create a small SB3 A2C model for vector maze observations."""
...
def load_a2c_model(model_path: str | Path) -> Any:
    """Load a saved SB3 A2C model from disk."""
